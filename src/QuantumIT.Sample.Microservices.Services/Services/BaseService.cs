...
{
    public abstract class BaseService<U, T> : IService<U, T>
  where U : class
  where T : class
    {
        protected readonly IUnitOfWork _unitOfWork;
        protected readonly IDBHelper _idbHelper;
        protected readonly IMapper _mapper;
        private string _sourceSystemReference;

        public BaseService(IUnitOfWork unitOfWork, IDBHelper idbHelper,IMapper mapper)
        {
        ...
        {
            get { return _sourceSystemReference; }
            set { _sourceSystemReference = value; }
        }
